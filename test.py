...
parser.add_argument('--weights_fpath', type=str,default = 'MSA2Net/msa2net_seed_1234_epoch_399.pth', help='weights file path') # path for best model's weights
