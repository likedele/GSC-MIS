...
from datasets_synapse import Synapse_dataset, RandomGenerator
...
def trainer_synapse(args, model, snapshot_path):
    ...
    # optimizer = optim.AdamW(model.parameters(),lr=base_lr/10.0, weight_decay=0.0001)
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            # loss2 = 0.5 * loss_ce + 0.5 * loss_dice
            loss2 = 0.4 * loss_ce + 0.6 * loss_dice
            # loss2 = loss_boundary
            ...
            if iter_num % 100 == 0:
                ...
                logging.info('iteration %d : loss_bo: %f' % (iter_num,acc_loss_bo))
                # acc_loss = 0.0
                # acc_loss_ce = 0.0
                # acc_loss_dc = 0.0
                acc_loss_bo = 0.0
